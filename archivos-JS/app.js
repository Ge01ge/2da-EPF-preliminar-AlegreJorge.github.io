...
verCarrito.className= "ver-carrito";
  // verCarrito.style.cursor= "pointer";
  // verCarrito.style.background= "gray";
...
// como deberia llamarlo entonces?
  ...
  // guardarcarrito.forEach( (el)=>{
  //   return new Producto(el.nombre, el.precio, el.cantidad, el.id, el.calidCantidad, el.img)
  // });
  // console.log(carrito)
});
